 ...
 * 句点は 。 と 、 を使う。全角ピリオドでは EdgeTTS が文の切れ目を認識せず、間が入らない。
...
export const SYSTEM_INTRO_SCRIPT: readonly IntroScene[] = [
  ...
  },
  {
    id: "generated-video",
    narration:
      "こちらが生成された動画です。問題分野・問題文の表示、問題を解く方針の説明、アニメーションを用いた音声解説が行われます。",
  ...
  },
  {
    ...
    narration:
      "解説動画に用いられるアニメーションは複数あります。関数グラフ、図形、表、ヒストグラムなど、解説に最適なアニメーションが用いられます。",
